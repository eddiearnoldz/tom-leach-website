...
<template>
  <div class="contact container">
    ...
    <a href="mailto:joey@halffullmgmt.com" target="_blank" alt="Mail" aria-label="Mail" >joey@halffullmgmt.com
      </a>
    ...
    <div class="contact_icons">
      ...
      <a class="contact_icon mail" href="mailto:joey@halffullmgmt.com" target="_blank" alt="Mail" aria-label="Mail">
        <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
